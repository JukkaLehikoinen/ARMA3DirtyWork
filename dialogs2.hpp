...
{
	idc = 1000;
	text = "Igor's arms, I like dollars instead of rubles."; //--- ToDo: Localize;
...
class lista: RscListbox
{
	...
	h = 0.33 * safezoneH;
	onMouseButtonClick = "_indexi = lbCurSel 1500; [_indexi,tuote4,asehinta4,toimitus4] execvm 'kone4ostolistaan.sqf';"
...
class osta: RscButton
{
	...
	w = 0.04125 * safezoneW;
	h = 0.055 * safezoneH;
	onButtonClick = "[] execVM 'kone4osta.sqf'";
};
class rynkyt: RscButton
{
	...
	w = 0.04125 * safezoneW;
	h = 0.055 * safezoneH;
	onButtonClick = "[] execVM 'rynkyt4.sqf'";
};
class ostoslista: RscListbox
{
	...
	h = 0.286 * safezoneH;
	onMouseButtonClick = "_indexi = lbCurSel 1500; [_indexi,tuote4,asehinta4,toimitus4] execvm 'kone4poislistalta.sqf';"
...
class singot: RscButton
{
	...
	h = 0.055 * safezoneH;
	onButtonClick = "[] execVM 'lippaat4.sqf'";
};
