...
class lista: RscListbox
{
	...
	h = 0.33 * safezoneH;
	onMouseButtonClick = "_indexi = lbCurSel 1500; [_indexi,tuote2,asehinta2,toimitus2] execvm 'kone3ostolistaan.sqf';"
...
class osta: RscButton
{
	...
	w = 0.04125 * safezoneW;
	h = 0.055 * safezoneH;
	onButtonClick = "[] execVM 'kone3osta.sqf'";
};
class rynkyt: RscButton
{
	...
	w = 0.04125 * safezoneW;
	h = 0.055 * safezoneH;
	onButtonClick = "[] execVM 'rynkyt2.sqf'";
};
class ostoslista: RscListbox
{
	...
	h = 0.286 * safezoneH;
	onMouseButtonClick = "_indexi = lbCurSel 1500; [_indexi,tuote2,asehinta2,toimitus2] execvm 'kone3poislistalta.sqf';"
...
class singot: RscButton
{
	...
	h = 0.055 * safezoneH;
	onButtonClick = "[] execVM 'lippaat2.sqf'";
};
