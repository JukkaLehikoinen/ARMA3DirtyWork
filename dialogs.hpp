...
class lista: RscListbox
{
	...
	h = 0.33 * safezoneH;
	onMouseButtonClick = "_indexi = lbCurSel 1500; [_indexi,tuote,asehinta,toimitus] execvm 'ostolistaan.sqf';"
...
class ostoslista: RscListbox
{
	...
	h = 0.286 * safezoneH;
	onMouseButtonClick = "_indexi = lbCurSel 1500; [_indexi,tuote,asehinta,toimitus] execvm 'poislistalta.sqf';"
...
class varusteet: RscButton
{
	...
	w = 0.04125 * safezoneW;
	h = 0.055 * safezoneH;
	onButtonClick = "[] execVM 'varusteet2.sqf'";
};
class summa: RscText
{
	idc = 1002;
