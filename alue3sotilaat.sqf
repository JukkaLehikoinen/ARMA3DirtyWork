...
_paikka = [(getpos kolalue select 0) + _pos1, (getpos kolalue select 1) + _pos2];
...
waypoint3 = [_solttu, _grp, index] execvm "waypointalue3sotilaat.sqf";
...
[_solttu, index] execvm "alue3kuolema.sqf";
[_solttu, _grp, index] execvm "pakoon3.sqf";
